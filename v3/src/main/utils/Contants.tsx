...
export const H1_FONT_SIZE = {fontSize: "28px"} // 200%
export const H2_FONT_SIZE = {fontSize: "175%"}
export const H3_FONT_SIZE = {fontSize: "150%"}

export const LIGHT_FONT_SIZE_1 = {fontSize: "13px"}
export const LIGHT_FONT_SIZE_2 = {fontSize: "12px"}
export const LIGHT_FONT_SIZE_3 = {fontSize: "11px"}
// export const SMALL
